        ...
        AbsListView.MultiChoiceModeListener
{
            ...
            try
            {
                ...
                switch (msg.what)
                {
                    ...
                    case MESSAGE_OBD_ECUS:
                        ...
                        if (m_bAutoConnecting)
                        {
                            mHandler.postDelayed(()-> setObdService(ObdProt.OBD_SVC_DATA, getString(R.string.obd_data)), 3000);
                        }
                        break;
    ...
    {
        if (m_bAutoConnecting && !ecuAdresses.isEmpty()) {
    ...
    public static boolean m_bAutoConnecting = false;
                        ...
                        case BLUETOOTH:
                            ...
                            } else
                            {
                                ...
                                } else
                                {
                                    ...
                                    Intent serviceIntent = new Intent(this, BtDeviceConnectService.class);
    ...
    private final Messenger messenger = new Messenger(new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            String address = msg.getData().getString(BtDeviceConnectService.EXTRA_DEVICE_ADDRESS);
            // save reported address as last setting
            prefs.edit().putString(PRESELECT.LAST_DEV_ADDRESS.toString(), address).apply();
